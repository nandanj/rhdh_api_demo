...
def create_scaffolder_task():
    ...
    task_payload = {
        "templateRef": "quarkus-web-template", # Replace with an actual template ID if known
        "values": {
            "projectName": "wf-simple-quarkus",
            "repoUrl": "https://gitlab-gitlab.apps.cluster-tvwbg.tvwbg.sandbox1943.opentlc.com/rhdh/template-quarkus-simple/-/blob/main/template.yaml?ref_type=heads",
            "owner": "dev1"
        },
        "createdBy": "scaffolder-app-user" # Optional, but good for tracking
    }
